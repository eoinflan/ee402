...
public class Client implements TempClientInterface{
	
	private static int portNumber = 5050;
    private Socket socket = null;
    private ObjectOutputStream os = null;
    private ObjectInputStream is = null;
    private TempReader TempRead = null;
    private String temp;
    ...
    public Client(String serverIP) {
		...
		this.getDate();
		this.TempRead = new TempReader(this);
		this.TempRead.getTemp();
				
    }
    
    public Client (TempReader TempRead) {
    ...
    private void sendTemp() {
    	System.out.println("I AM TRYING TO GET TEMP FROM OTHER CLASS");
    	
    	this.TempRead.getTemp();
        temp = this.TempRead.getTemp();
        String theTempCommand = "SendTemp", temp;
    ...
    {
    	//TempReader TempRead = new TempReader(null);

    	System.out.println("**. Java Client Application - EE402 OOP Module, DCU");
		Client theApp = new Client("192.168.1.1");
	 //   theApp.getDate();
	//    theApp.sendTemp();
